  ...
  return (
    <div className="page-content">
      ...
      <Article className="image-right a4" imgSrc="frederic.jpg" imgAlt="Frederic">
        <header className="header-top"><h1>Frederic</h1></header>
        ...
        <section>
          ...
          <h2>Listen to their music: <a href="https://www.youtube.com/channel/UCeoCO4_u1DdJBwyil66IsNw" >YouTube</a></h2>
        </section>
      </Article>

      <Article className="image-right a6" imgSrc="mrs-green-apple.jpg" imgAlt="Mrs. Green Apple">
        <header className="header-top"><h1>Mrs. Green Apple</h1></header>
      ...
      <Article className="image-left a7" imgSrc="the-cheserasera.jpg" imgAlt="The Cheserasera">
        ...
        <section>
          ...
          <h2>Listen to their music: <a href="https://www.youtube.com/c/TheCheserasera_japan" >YouTube</a></h2>
        </section>
      </Article>

      <Article className="image-right a2" imgSrc="kiki-vivi-lily.jpg" imgAlt="kiki vivi lily">
        <header className="header-top"><h1>kiki vivi lily</h1></header>
        ...
        <section>
          ...
          <h2>Listen to her music: <a href="https://www.youtube.com/channel/UC2qqLtG-gC_2MHj_-t_F13w" >YouTube</a></h2>
        </section>
      </Article>

      <Article className="image-right a9" imgSrc="the-pillows.jpg" imgAlt="The Pillows">
        <header className="header-top"><h1>The Pillows</h1></header>
        <header className="header-bottom"><h1>The Pillows</h1></header>
        <section>
          <h2>Learn more: <a href="http://pillows.jp" >pillows.jp</a></h2>
          <h2>Listen to their music: <a href="https://www.youtube.com/channel/UCJFJuYpd7mMeC9mZVdTqV1g" >YouTube</a></h2>
        </section>
      </Article>

      <Article className="image-left a11" imgSrc="kanako-ito.jpg" imgAlt="Kanako Ito">
        <header className="header-top"><h1>Kanako Ito</h1></header>
        ...
        <section>
          ...
          <h2>Listen to her music: <a href="https://www.youtube.com/channel/UCpFgEr3XUXk_8wK8H9Dn6Cg" >YouTube</a></h2>
        </section>
      </Article>

      <Article className="image-left a12" imgSrc="indigo-la-end.jpg" imgAlt="Indigo la End">
        <header className="header-top"><h1>Indigo la End</h1></header>
        <header className="header-bottom"><h1>Indigo la End</h1></header>
        <section>
          <h2>Learn more: <a href="https://indigolaend.com" >indigolaend.com</a></h2>
          <h2>Listen to their music: <a href="https://www.youtube.com/channel/UCXKSbzihU5cu0U4qbbjB3GA" >YouTube</a></h2>
        </section>
      </Article>
    </div>
  );
